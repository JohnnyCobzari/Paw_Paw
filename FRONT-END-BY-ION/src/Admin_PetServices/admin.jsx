...
function NewUserItem({ item, onDelete, onApprove }) {
	return (
		<li style={styles.listItem}>
			<div>
				<p>
					<strong>Company Director:</strong> {item.companyDirector}
				</p>
				<p>
				...
				{item.documentImageUrl && (
					<p>
						<strong>Document Image:</strong> <img src={item.documentImageUrl} alt="Document" width={100} />
					</p>
				)}
	...
	return (
		<li style={styles.listItem}>
			<div>
				...
				<p>
					<strong>Information:</strong> {item.information}
				</p>
				<p>
...
function Admin() {
	...
	useEffect(() => {
		...
		axios
			.get("http://localhost:3002/admin/waiting-list-add", config)
			.then((response) => {
		...
		axios
			.get("http://localhost:3002/admin/waiting-list", config)
			.then((response) => {
		...
		axios
			.get("http://localhost:3002/admin/waiting-list-notification", config)
			.then((response) => {
	...
	const handleDeleteShop = (shop) => {
		...
		axios
			.post(`http://localhost:3002/admin/reject-add/${shop._id}`, {}, config)
			.then((response) => {
	...
	const handleDeleteCertificate = (certificate) => {
		...
		axios
			.post(`http://localhost:3002/admin/reject/${certificate._id}`, {}, config)
			.then((response) => {
	...
	const handleDeleteNotification = (notification) => {
		...
		axios
			.post(`http://localhost:3002/admin/reject-notification/${notification._id}`, {}, config)
			.then((response) => {
	...
	const handleApproveShop = (shop) => {
		...
		axios
			.post(`http://localhost:3002/admin/approve-add/${shop._id}`, {}, config)
			.then((response) => {
	...
	const handleApproveCertificate = (certificate) => {
		...
		axios
			.post(`http://localhost:3002/admin/approve/${certificate._id}`, {}, config)
			.then((response) => {
	...
	const handleApproveNotification = (notification) => {
		...
		axios
			.post(`http://localhost:3002/admin/approve-notification/${notification._id}`, {}, config)
			.then((response) => {
